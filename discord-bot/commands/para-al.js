...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('para-al')
    .setDescription('Kullanicidan para al')
    .addUserOption(opt => opt.setName('kullanici').setDescription('Para alinacak kisi').setRequired(true))
  ...
  async execute(interaction) {
    ...
    await interaction.reply({
      embeds: [new EmbedBuilder()
        .setTitle(':money_with_wings: Para Alindi!')
        .setDescription(`${hedef} kullanicisindan **${miktar} TL** alindi!\nYeni bakiye: **${bakiyeAl(hedef.id)} TL**`)
        .setColor(0xFF0000)
        .setTimestamp()],
    });
  },
